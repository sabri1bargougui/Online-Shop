...
import 'package:happy_shop/Features/Presentation/Favorite/Widget/Favorite_OverViewScreen.dart';
        ...
        child: Column(
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: _productServices.getFavoriteItem(),
                ...
                switch (snapshot.connectionState) {
                  ...
                  default:
                    if (snapshot.hasError) {
                      ...
                      if (announce.isEmpty) {
                        return EmptyWidgetScreen(
                            title: 'No ads found', subtitle: 'Add an annonce');
                      } else
                        return Padding(
