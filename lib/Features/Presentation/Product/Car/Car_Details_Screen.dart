              ...
              child: Stack(
                children: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream:
                        _productServices.getFavoriteIcon(widget.idAnnounce!),
                                ...
                                child: Container(
                                  child: FavoriteButton(
                                    ...
                                    valueChanged: (_isfavorite) async {
                                      _productServices.createCarFavoriteItem(
                                          widget.idAnnounce,
                                          widget.categorie,
                                          widget.condition,
                                          widget.description,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.nombrePorte.toString()),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.nombrePlaces.toString()),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.puissanceFiscale.toString()),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.puissanceDin.toString()),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.kilometrage.toString()),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
