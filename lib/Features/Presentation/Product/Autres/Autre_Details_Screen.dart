...
class AutresDetailsScreen extends StatefulWidget {
  ...
  @override
  _AutresDetailsScreenState createState() => _AutresDetailsScreenState();
}

class _AutresDetailsScreenState extends State<AutresDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: widget.sellerID != _auth.currentUser!.uid
          ? Container(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 5),
                                  Text(
                                    'Member since ${widget.sellerDate}',
                                    style: TextStyle(
