...
class MotosDetailsScreen extends StatefulWidget {
  ...
  @override
  _MotosDetailsScreenState createState() => _MotosDetailsScreenState();
}

class _MotosDetailsScreenState extends State<MotosDetailsScreen> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('${widget.kilometrage.toString()} KM'),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
