...
class ImmmobilierDetailsScreen extends StatefulWidget {
  ...
  @override
  _ImmmobilierDetailsScreenState createState() =>
      _ImmmobilierDetailsScreenState();
}

class _ImmmobilierDetailsScreenState extends State<ImmmobilierDetailsScreen> {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 5),
                                  Text(
                                    'Membre depuis ${widget.sellerDate}',
                                    style: TextStyle(
