...
import 'package:happy_shop/Features/Presentation/Announcement/Multimedia/announcement_multimedia_preview.dart';
import 'package:top_snackbar_flutter/custom_snack_bar.dart';
import 'package:top_snackbar_flutter/top_snack_bar.dart';

class StateAndPriceMultimediaItemScreen extends StatefulWidget {
  final String categorie;
  final String announcementTitle;
  final String model;
  final String modelNumber;
  final String marque;
  final String genericeName;
  final String description;
  final List<String> urls;
  StateAndPriceMultimediaItemScreen({
    Key? key,
    required this.categorie,
    required this.announcementTitle,
    required this.description,
    required this.genericeName,
  ...
  @override
  _StateAndPriceMultimediaItemScreenState createState() =>
      _StateAndPriceMultimediaItemScreenState();
}

class _StateAndPriceMultimediaItemScreenState
    extends State<StateAndPriceMultimediaItemScreen> {
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        final String genericName = widget.genericeName;
